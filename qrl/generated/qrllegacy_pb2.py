...
_LEGACYMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vtData', full_name='qrl.LegacyMessage.vtData', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='syncData', full_name='qrl.LegacyMessage.syncData', index=11,
