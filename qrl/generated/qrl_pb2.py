...
_TRANSACTION = _descriptor.Descriptor(
  ...
  nested_types=[_TRANSACTION_TRANSFER, _TRANSACTION_STAKE, _TRANSACTION_DESTAKE, _TRANSACTION_COINBASE, _TRANSACTION_LATTICEPUBLICKEY, _TRANSACTION_DUPLICATE, _TRANSACTION_VOTE, _TRANSACTION_MESSAGE, ],
  enum_types=[
    _TRANSACTION_TYPE,
  ],
  options=None,
