...
_BLOCKHEADEREXTENDED = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='separate_transaction_count', full_name='qrl.BlockHeaderExtended.separate_transaction_count', index=4,
...
_BLOCKHEADEREXTENDED.fields_by_name['separate_transaction_count'].message_type = _TRANSACTIONCOUNT
