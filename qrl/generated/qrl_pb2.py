...
_UNSIGNEDTRANSACTIONREQ = _descriptor.Descriptor(
  name='UnsignedTransactionReq',
  full_name='qrl.UnsignedTransactionReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='transaction', full_name='qrl.UnsignedTransactionReq.transaction', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UNSIGNEDTRANSACTIONRESP = _descriptor.Descriptor(
  name='UnsignedTransactionResp',
  full_name='qrl.UnsignedTransactionResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='transaction', full_name='qrl.UnsignedTransactionResp.transaction', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UNSIGNEDTRANSACTIONREQ.fields_by_name['transaction'].message_type = _TRANSACTION
_UNSIGNEDTRANSACTIONRESP.fields_by_name['transaction'].message_type = _TRANSACTION
...
DESCRIPTOR.message_types_by_name['UnsignedTransactionReq'] = _UNSIGNEDTRANSACTIONREQ
DESCRIPTOR.message_types_by_name['UnsignedTransactionResp'] = _UNSIGNEDTRANSACTIONRESP
...
UnsignedTransactionReq = _reflection.GeneratedProtocolMessageType('UnsignedTransactionReq', (_message.Message,), dict(
  DESCRIPTOR = _UNSIGNEDTRANSACTIONREQ,
  __module__ = 'qrl_pb2'
  # @@protoc_insertion_point(class_scope:qrl.UnsignedTransactionReq)
  ))
_sym_db.RegisterMessage(UnsignedTransactionReq)

UnsignedTransactionResp = _reflection.GeneratedProtocolMessageType('UnsignedTransactionResp', (_message.Message,), dict(
  DESCRIPTOR = _UNSIGNEDTRANSACTIONRESP,
  __module__ = 'qrl_pb2'
  # @@protoc_insertion_point(class_scope:qrl.UnsignedTransactionResp)
  ))
_sym_db.RegisterMessage(UnsignedTransactionResp)
...
_PUBLICAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetUnsignedTransaction',
    full_name='qrl.PublicAPI.GetUnsignedTransaction',
    index=13,
    containing_service=None,
    input_type=_UNSIGNEDTRANSACTIONREQ,
    output_type=_UNSIGNEDTRANSACTIONRESP,
    options=None,
  ),
])
