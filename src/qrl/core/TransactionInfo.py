...
class TransactionInfo:
    ...
    particular Transaction is stale, so it includes information like when you
    received the transaction, and which blockheight were you on.
    It is also used by the block explorer.
    """
