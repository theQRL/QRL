...
_TRANSACTIONPOOLMANIFEST = _descriptor.Descriptor(
  name='TransactionPoolManifest',
  full_name='qrl.TransactionPoolManifest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='txhashes', full_name='qrl.TransactionPoolManifest.txhashes', index=0,
      number=1, type=12, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRANSACTIONPOOLCONTENT = _descriptor.Descriptor(
  name='TransactionPoolContent',
  full_name='qrl.TransactionPoolContent',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tx', full_name='qrl.TransactionPoolContent.tx', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='block_number', full_name='qrl.TransactionPoolContent.block_number', index=1,
      number=2, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='qrl.TransactionPoolContent.timestamp', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRANSACTIONPOOLCONTENT.fields_by_name['tx'].message_type = _TRANSACTION
...
DESCRIPTOR.message_types_by_name['TransactionPoolManifest'] = _TRANSACTIONPOOLMANIFEST
DESCRIPTOR.message_types_by_name['TransactionPoolContent'] = _TRANSACTIONPOOLCONTENT
...
TransactionPoolManifest = _reflection.GeneratedProtocolMessageType('TransactionPoolManifest', (_message.Message,), dict(
  DESCRIPTOR = _TRANSACTIONPOOLMANIFEST,
  __module__ = 'qrl_pb2'
  # @@protoc_insertion_point(class_scope:qrl.TransactionPoolManifest)
  ))
_sym_db.RegisterMessage(TransactionPoolManifest)

TransactionPoolContent = _reflection.GeneratedProtocolMessageType('TransactionPoolContent', (_message.Message,), dict(
  DESCRIPTOR = _TRANSACTIONPOOLCONTENT,
  __module__ = 'qrl_pb2'
  # @@protoc_insertion_point(class_scope:qrl.TransactionPoolContent)
  ))
_sym_db.RegisterMessage(TransactionPoolContent)
