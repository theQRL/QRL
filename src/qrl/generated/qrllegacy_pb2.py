...
_LEGACYMESSAGE_FUNCNAME = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MC', index=20, number=20,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MS', index=21, number=21,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MV', index=22, number=22,
      options=None,
      type=None),
  ],
...
_LEGACYMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mcData', full_name='qrl.LegacyMessage.mcData', index=21,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='msData', full_name='qrl.LegacyMessage.msData', index=22,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mvData', full_name='qrl.LegacyMessage.mvData', index=23,
...
_LEGACYMESSAGE.fields_by_name['mcData'].message_type = qrl__pb2._TRANSACTION
_LEGACYMESSAGE.fields_by_name['msData'].message_type = qrl__pb2._TRANSACTION
_LEGACYMESSAGE.fields_by_name['mvData'].message_type = qrl__pb2._TRANSACTION
...
_LEGACYMESSAGE.oneofs_by_name['data'].fields.append(
  _LEGACYMESSAGE.fields_by_name['mcData'])
_LEGACYMESSAGE.fields_by_name['mcData'].containing_oneof = _LEGACYMESSAGE.oneofs_by_name['data']
_LEGACYMESSAGE.oneofs_by_name['data'].fields.append(
  _LEGACYMESSAGE.fields_by_name['msData'])
_LEGACYMESSAGE.fields_by_name['msData'].containing_oneof = _LEGACYMESSAGE.oneofs_by_name['data']
_LEGACYMESSAGE.oneofs_by_name['data'].fields.append(
  _LEGACYMESSAGE.fields_by_name['mvData'])
_LEGACYMESSAGE.fields_by_name['mvData'].containing_oneof = _LEGACYMESSAGE.oneofs_by_name['data']
