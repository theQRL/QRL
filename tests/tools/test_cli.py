...
addr_hex_1 = "Q01050000a31343e48abce29464f063b30827ecf2c552743cab13d4f3b457b55410b548a0f8bca6"
addr_b32_1 = "q1qyzsqq9rzdp7fz4uu22xfurrkvyz0m8jc4f8g09tz0208dzhk42ppd2gaxq30m"
addr_hex_2 = "Q0105009ca50ed86497e6b2cfcca8c525191c741220eacf79a697e078bf9b53a9899b17b3f839d1"
addr_b32_2 = "q1qyzsp899pmvxf9lxkt8ue2x9y5v3caqjyr4v77dxjls830um2w5cnxchvu0eq0"
addr_hex_3 = "Q010500e135decb3328a27e51c47064df2dbbe799e79812291cc5e7cfad08a82a62d64e4fa813aa"
addr_b32_3 = "q1qyzspcf4mm9nx29z0egugurymukmheueu7vpy2guchnultgg4q4x94jwppy37z"
addr_hex_4 = "Q0105001fa3a2038c0b4b947cccbf589d53fc7749f0a04f118ec1ffadedd1b4db37e83c513aa259"
addr_b32_4 = "q1qyzsq8ar5gpccz6tj37ve06cn4flca6f7zsy7yvwc8l6mmw3kndn06put4284k"
...
class TestCLI(TestCase):
    ...
    def test_tx_transfer(self, mock_stub):
        ...
        # Should work with src=bech32address as well
        result = self.runner.invoke(qrl_cli, [
            "tx_transfer",
            "--src={}".format(wallet["addresses"][0]["address"]),
            "--master=",
    ...
    def test_tx_transfertoken_invalid_input(self, mock_stub):
        ...
        #                              "--token_txhash={}".format(txhash), "--dsts={}".format(addr_hex_1), "--amounts=10",
    ...
    def test_token_list_invalid_input(self, mock_stub):
        m_address_state_resp = mock.MagicMock(name='this should be the addressStateResp')
        m_address_state_resp.state.tokens = {addr_hex_1: 10, addr_hex_2: 100}
        ...
        result = self.runner.invoke(qrl_cli, ["token_list", "--owner={}".format(addr_hex_1[:-1])])
